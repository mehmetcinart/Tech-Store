  ...
  if (items.length === 0) {
    return (
      <div className="container" style={{ padding: "4rem 1rem", textAlign: "center" }}>
        ...
        <h2 style={{ fontSize: "1.375rem", marginTop: "1rem", marginBottom: ".5rem", color: "#111F1C" }}>
          Sepetiniz Boş
        </h2>
        <p style={{ color: "#8AADA4", marginBottom: "1.5rem" }}>Beğendiğiniz ürünleri sepete ekleyin</p>
      ...
      <div style={styles.layout}>
        ...
        <div>
          <div className="card" style={{ padding: "1.5rem" }}>
            ...
            {shipping > 0 && (
              <p style={styles.shippingNote}>200₺ üzeri alışverişlerde kargo ücretsiz</p>
            )}
            ...
            <Link to="/products" style={{ display: "block", textAlign: "center", marginTop: ".875rem", fontSize: ".875rem", color: "#8AADA4" }}>
              Alışverişe Devam Et
            </Link>
          </div>
        </div>
...
const styles = {
  ...
  itemImage:    { width: "90px", height: "90px", objectFit: "contain", background: "#F7F9F8", borderRadius: "8px", padding: ".5rem", flexShrink: 0 },
  itemInfo:     { flex: 1, minWidth: 0 },
  itemName:     { fontWeight: 600, fontSize: ".9rem", color: "#111F1C", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" },
  itemBrand:    { fontSize: ".75rem", color: "#B8CFC8", marginTop: ".2rem" },
  itemPrice:    { color: "#2C7A5E", fontWeight: 600, fontSize: ".9rem", marginTop: ".375rem" },
  ...
  qtyBtn:       { width: "32px", height: "32px", border: "none", background: "#F7F9F8", fontWeight: 700, cursor: "pointer", color: "#2C7A5E" },
  qtyNum:       { width: "40px", textAlign: "center", fontWeight: 600, fontSize: ".875rem" },
  lineTotal:    { fontWeight: 700, fontSize: ".9rem", color: "#111F1C" },
  removeBtn:    { background: "none", border: "none", color: "#e05252", fontSize: ".8rem", cursor: "pointer" },
  summaryTitle: { fontSize: "1.1rem", fontWeight: 700, marginBottom: "1.25rem", color: "#111F1C" },
  summaryRow:   { display: "flex", justifyContent: "space-between", fontSize: ".9rem", marginBottom: ".75rem", color: "#2C4F48" },
  divider:      { height: "1px", background: "#D9E4E0", margin: "1rem 0" },
  shippingNote: { fontSize: ".75rem", color: "#d4a017", marginTop: "-.375rem", marginBottom: ".5rem" },
};
